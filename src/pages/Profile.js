      ...
      <Row className='mt-4'>
        <div className='sidenav vh-100 col-3 d-flex flex-column'>
          <div className='d-flex flex-row justify-content-end'>
            <img className='rounded-circle' src={`${REACT_APP_BACKEND_URL}/${urlPicture}`}  alt='avatar' style={{width: 70, height: 70}} />
          ...
          <Card className='p-3'>
            ...
            <Row>
              ...
              <div className='col-4 d-flex flex-column'>
                <img src={`${REACT_APP_BACKEND_URL}/${urlPicture}`}  alt='smile' style={{width: 120, height: 120}} />
                {/* <Input type='file'/>  */}
